    ...
    <>
      ...
      <section className="py-[5rem] wrapper grid gap-10 lg:grid-cols-2">
        <div className="flex flex-col">
          ...
          <p data-aos="fade-right" className="description mt-4">
            ...
            crafting custom software, mobile apps, and web solutions. Leveraging
            cutting-edge technologies such as AI, Machine Learning, Data
            Engineering, and IoT, we drive innovation and growth for businesses
            globally.
            <br />
            <br />
            We also provide Cloud Migration, IT consulting and strategy, robust
            Cybersecurity, IT infrastructure management, and user-centric UX/UI
            design. With a proven track record of successful collaborations with
            over 30 companies, we are committed to turning your vision into
            reality and achieving outstanding results.
          </p>
        </div>
        <div
          data-aos="fade-left"
      ...
      <section className="wrapper">
        ...
        <p data-aos="fade-right" className="description mt-3">
          ...
          didn’t want to be just another tech company; we wanted to be pioneers,
          bridging the gap between complex AI possibilities and real-world
          solutions that benefit people.
          <br />
          <br />
          Our journey started with a small, passionate team of AI enthusiasts
          who shared a big dream to create AI that doesn’t just process data but
          understands human needs and context. Through late nights, creative
          thinking, and curiosity, we set out to change the way AI could impact
          the world.
        </p>
        ...
        <p data-aos="fade-right" className="description mt-3">
          ...
          solutions, making a difference in industries like healthcare, finance,
        ...
        <p className="mt-5 description">
          We don't just build technology — we create smart solutions that solve
          real-world problems. Every project we complete reflects our dedication
          to pushing the limits of AI’s potential.
        </p>
      </section>
