    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="mt-3 flex flex-col gap-4 md:px-5">
        ...
        <p data-aos="fade-up" className="description">
          ...
          lakes—ensuring optimal performance, scalability, and security. Whether
          you're modernizing your data infrastructure or building it from
          scratch, our data engineering solutions enable you to extract
