    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4 md:px-5">
        ...
        <p data-aos="fade-up" className="description">
          ...
          innovation. From custom applications to enterprise software solutions,
          businesses require reliable, scalable, and secure software to meet
          evolving market demands. We specialize in building tailored software
          that drives operational efficiency, enhances customer experience, and
      ...
      <div className="mt-3 flex flex-col gap-4 md:px-5">
        ...
        <p data-aos="fade-up" className="description">
          ...
          <ul className="list-disc pl-6 mt-2">
            <li>
              Custom Software Development: Tailored applications that align with
              your business goals.
            </li>
            <li>
              Enterprise Software Solutions: Robust, scalable solutions designed
              to handle complex organizational needs.
            </li>
            <li>
          ...
          frameworks, including Java, Python, C#, .NET, and JavaScript, ensuring
          that we select the best technologies for your project. We also focus
          on security, performance, and user experience to deliver high-quality
