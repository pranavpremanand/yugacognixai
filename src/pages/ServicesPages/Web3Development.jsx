    ...
    <FadeUp>
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-4 md:px-5">
          <h2 className="text-3xl font-semibold">Web3 Development</h2>
          <p className="description">
            ...
            transparency, and user control. As the future of the internet
            unfolds, businesses must embrace these new technologies to remain
            competitive.
            <br />
            <br />
            Web3 development is not just about creating decentralized
            applications (dApps) but also about integrating innovative
            technologies that allow users to have ownership of their data and
            digital assets. From decentralized finance (DeFi) to NFTs, Web3
        ...
        <div className="mt-3 flex flex-col gap-4 md:px-5">
          ...
          <p className="description">
            ...
            blockchain-based applications or integrate smart contracts, we
            provide the expertise to bring your vision to life.
          </p>
          <img
            src={img2}
            loading="lazy"
